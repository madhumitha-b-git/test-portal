    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-blue-600 selection:text-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full p-4 sm:p-6 lg:p-8 my-4">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
            ...
            {descriptiveQuestions.length > 0 && (
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 text-center">
                    <p className="text-xl font-extrabold text-purple-700">{descriptiveQuestions.length}</p>
                    <p className="text-[10px] text-slate-500 font-bold uppercase mt-1">Total</p>
                  </div>
                  <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-200 text-center">
                    <p className="text-xl font-extrabold text-emerald-700">{descriptiveAnsweredCount}</p>
                    <p className="text-[10px] text-emerald-800 font-bold uppercase mt-1">Answered</p>
                  </div>
                  <div className="bg-amber-50 p-3 rounded-lg border border-amber-200 text-center">
                    <p className="text-xl font-extrabold text-amber-700">{descriptiveUnansweredCount}</p>
                    <p className="text-[10px] text-amber-800 font-bold uppercase mt-1">Unanswered</p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6 mb-8 max-h-[380px] overflow-y-auto pr-2">
                ...
                <div className="space-y-2">
                  {descriptiveQuestions.map((q, idx) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="w-6 h-6 rounded bg-purple-100 text-purple-800 flex items-center justify-center font-bold text-[11px]">
                            {idx + 1}
                          </span>
                          <span className="text-slate-800 font-medium truncate max-w-[280px] sm:max-w-md">
                            {q.question || q.text}
                        ...
                        {isAnswered ? (
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded bg-purple-100 text-purple-800 font-bold text-[11px] border border-purple-200">
